...
const Home = () => {
  return (
    ...
    <main className={style.container}>
      ...
      <Title className={style.containerDivTitle} content='Sr. Cabeça de abóbora em: Noite de Todos os Santos Curatorial'/>
      <Text content= 'Bem-vindos apaixonados por folcore! Esta é a jornada única no mundo da sétima arte! Aqui você vai explorar o meu papel de curador. Suas percepções sobre o bem e o mal vão se expandir E seus horizontes culturais serão ampliados.'/>
      ...
      <Title className={style.containerDivTitle} content='Solte a bruxa, livre-se dos fantasmas e assista!'/>
      </div> 
    </main>
    <section className={style.containerRecentes}>
    <Listagem />
    </section>
